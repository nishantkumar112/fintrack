...
import com.fintrack.fintrack_dashboard.service.analytics.AnalyticsService;
...
public class AnalyticsController {
    ...
    @GetMapping("/recent")
    public PaginatedResponse<TransactionResponse> getRecent(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "5") int size) {
        return analyticsService.getRecentTransactions(page, size);
    }
}
